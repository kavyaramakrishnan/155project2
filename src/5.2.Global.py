...
def main():
    ...
    U, V, UBias, VBias, err, mu = train_model_bias(M, N, k, eta, reg, Y_train, globalBiasMu = True)
    ...
    plt.savefig('Global-popular.png')
    plt.clf()
